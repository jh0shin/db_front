...
// Manage
export const MANAGE_MAIN = "MANAGE_MAIN";
export const PARTICIPANT_ADD = "PARTICIPANT_ADD";
export const PARTICIPANT_ADD_SUCCESS = "PARTICIPANT_ADD_SUCCESS";
export const PARTICIPANT_ADD_FAILURE = "PARTICIPANT_ADD_FAILURE";
export const DATATYPE_ADD = "DATATYPE_ADD";
export const DATATYPE_ADD_SUCCESS = "DATATYPE_ADD_SUCCESS";
export const DATATYPE_ADD_FAILURE = "DATATYPE_ADD_FAILURE";
export const PASSVAL_SET = "PASSVAL_SET";
export const PASSVAL_SET_SUCCESS = "PASSVAL_SET_SUCCESS";
export const PASSVAL_SET_FAILURE = "PASSVAL_SET_FAILURE";
