...
class UserModify extends Component {
    ...
    handleModify = () => {
        ...
        axios.post("http://localhost:3031/api/user/modify/", {
            ...
            if (this.state.role === "A")
                ...
                window.location.assign("http://localhost:3031/submitter?id=" + this.state.id)
            else
                window.location.assign("http://localhost:3031/evaluater?id=" + this.state.id)
        }).catch((e) => {});
    }
    ...
    handleWithdraw = async () => {
        if(this.state.id === "admin") { 
            ...
            axios.post("http://localhost:3031/api/user/delete/", {
                "userid": this.state.id
            }).then((response) => {
    ...
    loadData = async () => {
        axios.post("http://localhost:3031/api/user/info/", {
